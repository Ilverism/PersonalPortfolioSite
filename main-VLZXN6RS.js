...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `});var s=2,o=window.innerWidth/window.innerHeight;let a=o>1?new Lr(s*o,s):new Lr(s,s*o),c=new Zt(a,r);this.scene.add(c),this.camera.position.set(0,0,1);let l=Date.now(),u=()=>{requestAnimationFrame(u);let d=(Date.now()-l)*1e-5;r.uniforms.time.value=d,i.render()};u()}onResize(){this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.renderer.setSize(window.innerWidth,window.innerHeight)}};e.\u0275fac=function(r){return new(r||e)(bo(Fn))},e.\u0275cmp=ss({type:e,selectors:[["app-shader-background"]],viewQuery:function(r,s){if(r&1&&oy(qN,7),r&2){let o;Jd(o=Kd())&&(s.containerRef=o.first)}},hostBindings:function(r,s){r&1&&Ec("resize",function(){return s.onResize()},!1,uv)},standalone:!0,features:[ls],decls:2,vars:0,consts:[["shaderContainer",""]],template:function(r,s){r&1&&pr(0,"div",null,0)},styles:["html[_ngcontent-%COMP%], body[_ngcontent-%COMP%]{margin:0;padding:0;overflow:hidden;height:100%}"]});let n=e;return n})();var wx=(()=>{let e=class e{};e.\u0275fac=function(r){return new(r||e)},e.\u0275cmp=ss({type:e,selectors:[["app-root"]],standalone:!0,features:[ls],decls:1,vars:0,template:function(r,s){r&1&&pr(0,"app-shader-background")},dependencies:[Mx],styles:["html[_ngcontent-%COMP%], body[_ngcontent-%COMP%]{margin:0;padding:0;overflow:hidden;height:10%}"]});let n=e;return n})();Gy(wx,A0).catch(n=>console.error(n));
