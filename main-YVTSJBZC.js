...
The shaders could take a moment to load, and may not display correctly on some devices.`),re(),Ce("name","Ring War")("iconDef",a.faSteam)("buttonColor","#171a21")("isExternalLink",!0)("clickEvent",a.onClickRingWar)("description",`Click to view the Steam page for my first publically-released game, Ring War.
...
The game entered Early Access in 2022, and remains in development between other projects.`),re(),Ce("name","LinkedIn")("iconDef",a.faLinkedin)("buttonColor","rgba(0, 123, 181, 1.00)")("isExternalLink",!0)("clickEvent",a.onClickLinkedIn)("description",`Click to view my LinkedIn page.
