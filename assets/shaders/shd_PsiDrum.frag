...
void main() {
    ...
    nBlended += disEdge+10.5-nBlended;
    
    float iTime = mod(time*5000., 200.0);
    nBlended = mix(nBlended, fbm(uv/nBlended)-iTime, disEdge);
    ...
    col = mix(
        vec3(0.0, 0.0, 0.0),
        vec3(8.0-uv0.y*4., 2.0+nBlended, 5.0),
